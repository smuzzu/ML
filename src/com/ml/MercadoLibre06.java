...
public class MercadoLibre06 extends Thread {
    ...
    static int[][] intervals = new int[][] {
            ...
            {0,300,1100,2147483647}, //gift card (general)
    ...
    public static void main(String[] args) {
        ...
        for (int j=0; j<urls.length; j++) { //todo tiene que empezar de 0
            ...
            int numberOfThreads=(int) Math.round(intervals[j].length-1);
            /*
            ...
            for (int i = 0; i < numberOfThreads; i++) {
                MercadoLibre06 thread = new MercadoLibre06();
