...
public class MercadoLibre02 extends Thread {
    ...
    static String[] urls = new String[]
            {"https://hogar.mercadolibre.com.ar/adornos-decoracion-del/[_SUBINTERVAL]",
             ...
             "https://hogar.mercadolibre.com.ar/articulos-limpieza-productos-limpiadores-alfombras/",
             "https://hogar.mercadolibre.com.ar/cuidado-del-lavanderia/lustra-muebles_DisplayType_G",
             "https://listado.mercadolibre.com.ar/lustramuebles_DisplayType_G",
    ...
    static int[][] intervals = new int[][]{
            {0, 11, 19, 26, 34, 39, 44, 49, 50, 59, 63, 69, 74, 79, 80, 89, 94, 98, 99, 100, 109, 114, 119, 120, 129, 133, 139, 144, 149, 150, 158,
                    ...
                    950, 959, 974, 975, 989, 998, 999, 1000, 1049, 1070, 1085, 1099, 1112, 1149, 1169, 1189, 1199, 1200, 1249, 1273, 1284, 1299, 1307, 1333,
                    1349,1389, 1399, 1423, 1450, 1494, 1496, 1499, 1500, 1559, 1599, 1631, 1689, 1690, 1698, 1699, 1720, 1760, 1790, 1798, 1799, 1800, 1828,
                    1890, 1931, 1960, 1998, 1999, 2000, 2098, 2140, 2199, 2219, 2276, 2299, 2301, 2330, 2340, 2390, 2400, 2458, 2499, 2500, 2580, 2600, 2700,
                    2790, 2879, 2900, 2999, 3000, 3111, 3299, 3499, 3501, 3570, 3648, 3800, 3939, 3999, 4050, 4199, 4499, 4650, 4861, 4950, 5000, 5268, 5600,
                    5942, 6100, 6623, 7562, 8799, 10000, 12000, 13998, 17000, 19721, 25000, 30000,74999, 2147483647},


            {2500, 2550, 2600, 2799, 2899, 2999, 3090, 3390, 3500, 3600, 3850, 4000, 4500, 5000, 5950, 7000, 9000, 13000, 17999, 23000, 40000, 2147483647}, //espejos

            {0, 400, 750, 1400, 2300, 3500, 7000, 9000, 14000, 30000, 2147483647}, //alfombras

            {0, 1000, 2147483647}, //hafele

            {0, 300, 900, 1500,3000,2147483647}, //genoud
            {0, 2147483647}, //fark

            {0, 2147483647}, //productos-limpiadores-alfombras
            {0, 2147483647}, //lustra-muebles
            {0, 2147483647}, //lustramuebles
            {0, 2147483647}, //blem
            {0, 400, 2147483647}, //stp
            {0, 2147483647} //rugbee
    };
                ...
                while (!endInterval) {
                    ...
                    for (String productUrl : productsURLArrayList) {
                        ...
                        if (!HttpUtils.isOK(htmlStringFromProductPage)){
                            String msg="All retries failed.  Ignoring this url "+productUrl;
                            System.out.println(msg);
                            Logger.log(msg);
                                ...
                                if (!ONLY_ADD_NEW_PRODUCTS) { //ignora los updates
                                    ...
                                    if (!sameDate || (sameDate && OVERRIDE_TODAYS_RUN)) { //actualizar
                                        ...
                                        if (totalSold != previousTotalSold) { //actualizar
                                            ...
                                            if (SAVE) {
                                                DatabaseHelper.updateProductAddActivity(DATABASE,OVERRIDE_TODAYS_RUN,getGlobalDate(),productId, seller, -1, officialStore, totalSold, newSold, title, productUrl, reviews, stars, price, newQuestions, lastQuestion, page, 0, shipping, discount, premium);
                                            }
